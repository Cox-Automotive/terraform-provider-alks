...
release:
	...
	zip terraform-provider-alks-windows-386_v$(TRAVIS_TAG).zip release/terraform-provider-alks_v$(TRAVIS_TAG).exe
	
	GOOS=windows GOARCH=amd64 go build -o release/terraform-provider-alks_v$(TRAVIS_TAG).exe $(package)
	zip terraform-provider-alks-windows-amd64_v$(TRAVIS_TAG).zip release/terraform-provider-alks_v$(TRAVIS_TAG).exe
